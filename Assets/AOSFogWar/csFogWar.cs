    ...
    public class csFogWar : MonoBehaviour
    {
        ...
        public class FogRevealer
        {
            public Vector2Int GetCurrentLevelCoordinates(csFogWar fogWar)
            {
                ...
                if (lastSeenAt == new Vector2Int(Int32.MaxValue, Int32.MaxValue))
                {
        ...
        private void UpdateFog()
        {
            ...
            foreach (FogRevealer fogRevealer in fogRevealers)
            {
                ...
                if (fogRevealer._UpdateOnlyOnMove == false || currentLevelCoordinates != fogRevealer._LastSeenAt)
                {
                    break;
                }
        ...
        public void AddFogRevealer(FogRevealer fogRevealer)
        {
